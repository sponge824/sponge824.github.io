...
By referring to the previous screenshot, the attacker is using a tool called `PSEXESVC.EXE` aka PsExec. It is a tool that access the system remotely via SMB protocol. For more information can refer to [PsExec-Hunt]({% link _posts/2026-05-26-PsExec-Hunt.md%})
